...
public class Platno {
     ...
     * @return --
     */
    public static Platno dajPlatno(Hra hra) {
        
        if (Platno.platnoSingleton == null) {
            Platno.platnoSingleton = new Platno("2D MienCroft", 750, 500, 
                                         Color.white, hra);
        }
     ...
     */
    private Platno(String titulok, int sirka, int vyska, Color pozadie, Hra hra) {
        this.frame = new GameFrame(hra);
    ...
    public void setForegroundColor(String farba) {
        if (farba.equals("red")) {
            ...
            this.graphic.setColor(new Color(50, 205, 50));
            ...
            this.graphic.setColor(new Color(139, 69, 19));
        } else if (farba.equals("gold")) {
            this.graphic.setColor(new Color(255, 215, 0));
        } else if (farba.equals("diamond")) {
            this.graphic.setColor(new Color(185, 242, 255));
        } else if (farba.equals("coal")) {
            this.graphic.setColor(new Color(44, 44, 44));
        } else {
            this.graphic.setColor(Color.black);
        }
    }
